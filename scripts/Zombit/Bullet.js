class Bullet extends TexturedEntity
{
    constructor(shooter)
    {
        super(shooter.getX() + (shooter.lastSide > 0 ? shooter.getWidth() : 0), shooter.getY() + (shooter.getHeight() * 0.4), shooter.getWidth() * 0.3, shooter.getHeight() * 0.3 * 0.583333333, (shooter.lastSide == -1 ? "assets/bullet_left.png" : "assets/bullet_right.png"));
